...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">starpath documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ArticleCard.html" data-type="entity-link" >ArticleCard</a>
                            </li>
                            <li class="link">
                                <a href="components/Contact.html" data-type="entity-link" >Contact</a>
                            </li>
                            <li class="link">
                                <a href="components/Download.html" data-type="entity-link" >Download</a>
                            </li>
                            <li class="link">
                                <a href="components/Feature.html" data-type="entity-link" >Feature</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/HowToPlay.html" data-type="entity-link" >HowToPlay</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/News.html" data-type="entity-link" >News</a>
                            </li>
                            <li class="link">
